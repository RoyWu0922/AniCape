...
let suites: [(name: String, run: () throws -> Void)] = [
    ...
    ("LocalizationKeys", testEveryKeyHasTextInBothLanguages),
    ("LocalizationTranslated", testEnglishIsActuallyTranslated),
    ("LocalizationPlaceholders", testPlaceholderCountsMatchAcrossLanguages),
    ("LocalizationFormat", testTemplatesFormatToExpectedStrings),
    ("LocalizationFormatEmoji", testEmojiTemplatesSubstituteWithoutLeftovers),
    ("LocalizationLanguage", testLanguageIdentityAndUnknownValue),
    ("LocalizationRoleNames", testRoleEnglishNamesAreUniqueAndResolvable),
    ("LocalizationRoleNamesSkipped", testRoleEnglishNamesAvoidSkippedNames),
